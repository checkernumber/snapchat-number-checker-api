# Snapchat Number Checker API — official examples | CheckNumber

This repository documents the CheckNumber Snapchat Number Checker API integration contract using facts from the expansion manifest.

- Product page: https://checknumber.ai/products/snapchat
...
```bash
curl -X POST "https://api.checknumber.ai/v1/tasks" -H "X-API-Key: ${CHECKNUMBER_API_KEY}" -F "file=@examples/numbers.txt" -F "task_type=snapchat"
...
| --- | --- | --- | --- | --- | --- |
| `snapchat` | Number Checker | phone | 2000–10000000 rows | `number, activated` | [docs](https://docs.checknumber.ai/snapchat-checker) |
...
- `snapchat`: https://docs.checknumber.ai/snapchat-checker
